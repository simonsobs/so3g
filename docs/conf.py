...
for missing in ('matplotlib', 'healpy', 'astropy', 'pytz',
...
latex_documents = [
    (master_doc, 'so3g.tex', 'so3g Documentation',
...
man_pages = [
    (master_doc, 'so3g', 'so3g Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'so3g', 'so3g Documentation',
     author, 'so3g', 'One line description of project.',
     'Miscellaneous'),
]
